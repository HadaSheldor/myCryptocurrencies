...
function pageObj() {
    ...
    this.displayAboutHtml = () => {
        ...
        const pageInfo = `
            ...
            <p class="pageInfo">In terms of design, most of <i style="color: #ef8440">All About Cryptocurrency</i>'s components were built using Bootstrap (CSS library) which allowed more flexability in terms of responsiveness and elements' positioning (grid-wise).<br><br> 
            A more elaborated characterisation can be found in the formal module's specification report (see. mega-school portal). </p>
        `;
